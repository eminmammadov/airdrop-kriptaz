...
import { Heading, Text, Display } from '@/components/fonts';
    ...
    <div className="min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <main className="max-w-4xl mx-auto space-y-12">
        ...
        <section className="text-center space-y-6">
          <Display size="xl" className="text-6xl text-white">
            SEO Test Environment
          </Display>
          <Text variant="body" className="text-xl text-gray-300 max-w-2xl mx-auto">
